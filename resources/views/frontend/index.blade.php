        ...
        <div class="side-menu animate-dropdown outer-bottom-xs">
          ...
          <nav class="yamm megamenu-horizontal">
            ...
            @foreach(session()->get('category') as $category)
              ...
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-" aria-hidden="true">{{$category['category_name']}}</i></a>
...
@foreach($slider as $slider)
            ...
            <div class="item" style="background-image: url({{asset('frontend/img/'.$slider->slider_image)}});">
              <div class="container-fluid">
                <div class="caption bg-color vertical-center text-left">
                  <div class="slider-header fadeInDown-1">Top Brands</div>
                  <div class="big-text fadeInDown-1"> {{$slider->slider_heading}} </div>
                  <div class="excerpt fadeInDown-2 hidden-xs"> <span>{{$slider->slider_content}}</span> </div>
...
@foreach($f_products as $f_product)
            ...
            <div class="item item-carousel">
              <div class="products">
                <div class="product">
                  <div class="product-image">
                    <div class="image"> <a href="{{route('frontend.product_detail',$f_product->pro_id)}}"><img  src="{{asset('frontend/img/'.$f_product->pro_image)}}" alt=""></a> </div>
                    <!-- /.image -->
                  ...
                  <div class="product-info text-left">
                    <h3 class="name"><a href="{{route('frontend.product_detail',$f_product->pro_id)}}">{{$f_product->pro_name}}</a></h3>
                    <div class="rating rateit-small"></div>
                    <div class="description"></div>
                    <div class="product-price"> <span class="price"> ${{$f_product->pro_price}} </span> <span class="price-before-discount">$ 800</span> </div>
                    <!-- /.product-price --> 
                  ...
                  <div class="cart clearfix animate-effect">
                    <div class="action">
                      <ul class="list-unstyled">
                        ...
                        @if(!session()->has('u'))
                          <a href="" class="btn btn-primary icon" data-toggle="modal" data-target="#myModal"> <i class="fa fa-shopping-cart"></i> </a>
                        @else
                        <form id = "{{$f_product->pro_id}}" method = "POST">
                          @csrf
                          <input type ="hidden" value = "{{$f_product->pro_id}}" name = "id">
                          <input type ="hidden" value = "1" name = "quan">
                        <button class="btn btn-primary icon" data-toggle="tooltip" type="submit" id = "btn_cart"> <i class="fa fa-shopping-cart"></i> </button>
